...
@if($edit)
{!! Form::model($permission, ['route' => ['permission.update', $permission->id], 'method' => 'PUT', 'id' => 'form-generic-modal', 'class' => 'form-horizontal']) !!}
@else
 {!! Form::open(['route' => 'permission.store', 'id' => 'form-generic-modal', 'class' => 'form-horizontal']) !!}
@endif
