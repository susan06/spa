	    ...
	    <div class="content">	    
			<div class="row">
			  <div class="col-md-12 col-xs-12">
			  	...
			  	<div class="col-md-3 col-xs-12 col-search mg-buttom-10">
					  ...
					  <button class="collapse-toggle visible-mobile btn btn-danger" type="button" id="btn-search-toggle" data-toggle="collapse" data-parent="custom-collapse" data-target="#side-menu-collapse" style="width: 100%;">
						...
						@endif
						@if(Settings::get('province_id'))
						  <li class="list-group-item">
						  	{!! Form::select('province_id', $provinces, old('province_id'), ['class' => 'form-control', 'id' => 'change_province', 'data-url' => route('local.search', 'province_id=true&search=true')]) !!}
						  </li>
						@endif
						</ul>
			    ...
			    <div id="tab-content" class="grid-local col-md-9 col-xs-12">
			        <!-- load result -->
			    </div>
			  </div>
			</div>
